    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <div class="u-row-container" style="padding: 0px;background-color: transparent">
                <div class="u-row"
                     style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #6259ca;">
                    <div
                            ...
                            <tr>
                                <td style="padding: 0px;background-color: transparent;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
                                        <tr style="background-color: #6259ca;"><![endif]-->
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td class="v-text-align"
                                                            ...
                                                            <img align="center" border="0" src="{{ asset('assets/img/logo/LB-Roofing-LLC.png') }}"
                                                                 alt="Logo" title="Logo"
                    ...
                    <div
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding: 0px;background-color: transparent;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
                                        <tr style="background-color: #34495e;"><![endif]-->
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;"
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p style="font-size: 14px; line-height: 150%;"> {{ __('lang.if_you_have_any_questions_feel_free_message_us_at', ['email' => '']) }}<span
                                                            style="color: #ffffff; font-size: 14px; line-height: 21px;"><a
                                                                rel="noopener" href="mailto:support@mailus.com"
                                                                target="_blank" style="color: #ffffff;">{{ env('EMAIL_CONTACT') }}</a>.</span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 150%;"> </p>
                                                    <p style="font-size: 14px; line-height: 150%;">{{ env('ADDRESS_FOOTER') }}</p>
                                                    <p style="font-size: 14px; line-height: 150%;"> </p>
                                                    <p style="font-size: 14px; line-height: 150%;">{{ __('lang.all_rights_reserved') }}.
                                                         <a rel="noopener" href="{{ env('DEVELOPER_BY_URL') }}"
                                                            target="_blank">{{ env('DEVELOPER_BY') }}</a></p>
                                                    <p style="font-size: 14px; line-height: 150%;"> </p>
                                                </div>
